...
namespace longmarch
{
	...
	private:
		// synchronization
		// cache aligned such that atomic variables do not trigger extra cache misses to each other
		CACHE_ALIGN64 std::mutex queue_mutex;
		CACHE_ALIGN64 std::condition_variable condition;
