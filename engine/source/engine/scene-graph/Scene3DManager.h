...
namespace longmarch
{
	...
	private:
		void RecurseLoad(Scene3DNode& sceneData, const std::string& sceneName, const fs::path& sceneDir, const aiScene* aiscene, const aiNode* node, const aiMatrix4x4& parentTr, unsigned int level);
	};
}