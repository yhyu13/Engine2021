...
longmarch::MainObjectFactory::MainObjectFactory()
{
	...
	const LongMarch_Vector<std::string> componentSys{
		...
		"AIControllerComSys",
		"Particle3DComSys",
		"Prototype2PlayerController",
		"Prototype2CameraController",
		"Prototype2PlayerArsenalComSys"
		"Prototype2CameraController",
		"Prototype2EnemyGeneratorSystem"
	};
...
std::shared_ptr<BaseComponentSystem> longmarch::MainObjectFactory::AddComponentSystemByName(const std::string& comsys_type, GameWorld* world) const
{
	...
	if (!system)
	{
		...
		*/
		...
		{"Particle3DComSys", 7},
		{"Prototype2PlayerController", 8},
		{"Prototype2CameraController", 9},
		{"Prototype2PlayerArsenalComSys", 10},
		{"Prototype2EnemyGeneratorSystem", 11}
		};
		...
		if (const auto& it = m.find(comsys_type); it != m.end())
		{
			...
			*/
			...
			case 7:
				...
				break;			
			case 8:
				system = MemoryManager::Make_shared<Prototype2PlayerController>();
				break;			
			case 9:
				system = MemoryManager::Make_shared<Prototype2CameraController>();
				break;			
			case 10:
				system = MemoryManager::Make_shared<Prototype2PlayerArsenalComSys>();
				break;
			case 11:
				system = MemoryManager::Make_shared<Prototype2EnemyGeneratorSystem>();
				break;
			default:
...
void longmarch::MainObjectFactory::LoadResources(const fs::path& _filepath, GameWorld* world) const
{
	auto filepath = FileSystem::ResolveProtocol(_filepath);
	FileSystem::ExistCheck(filepath);
