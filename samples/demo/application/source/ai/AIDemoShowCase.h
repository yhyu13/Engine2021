...
namespace longmarch
{
	void AIDemoShowCase() //Runs prefectly with taksh_scene-game & game2
	{
		...
		//	aicomp->SetBT(FileSystem::ResolveProtocol("$asset:/BehaviorTrees/TestBehaviorTree.json"));
		...
		//	// Setting up BT and Blackboard
		//	aicomp2->SetBT(FileSystem::ResolveProtocol("$asset:/BehaviorTrees/Patrol_in_XAndCatch.json"));
		...
		//	// Setting up BT and 
		//	aicomp3->SetBT(FileSystem::ResolveProtocol("$asset:/BehaviorTrees/Patrol_in_YAndCatch.json"));
