...
namespace longmarch
{
    struct PathMoverData
    {
        ...
        //!< total time determined by intergrating the trapezoidal made by speed ramping up/down and the total arc length
        bool pause{false};
    };
    ...
    private:
        inline static Vec3f Points[] = {
            Vec3f(RAND_I(-30, 30), RAND_I(-30, 30), -10), Vec3f(RAND_I(-30, 30), RAND_I(-30, 30), -10),
            Vec3f(RAND_I(-30, 30), RAND_I(-30, 30), -10),
            Vec3f(RAND_I(-30, 30), RAND_I(-30, 30), -10), Vec3f(RAND_I(-30, 30), RAND_I(-30, 30), -10),
            Vec3f(RAND_I(-30, 30), RAND_I(-30, 30), -10),
            Vec3f(RAND_I(-30, 30), RAND_I(-30, 30), -10), Vec3f(RAND_I(-30, 30), RAND_I(-30, 30), -10),
            Vec3f(RAND_I(-30, 30), RAND_I(-30, 30), -10),
